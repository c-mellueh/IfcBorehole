...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(0, QFormLayout.ItemRole.LabelRole, self.la_application_name)

        self.le_application_name = QLineEdit(self.tab)
        self.le_application_name.setObjectName(u"le_application_name")

        self.formLayout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.le_application_name)

        self.la_application_version = QLabel(self.tab)
        self.la_application_version.setObjectName(u"la_application_version")

        self.formLayout.setWidget(1, QFormLayout.ItemRole.LabelRole, self.la_application_version)

        self.le_application_version = QLineEdit(self.tab)
        self.le_application_version.setObjectName(u"le_application_version")

        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.le_application_version)
        ...
        self.formLayout.setWidget(2, QFormLayout.ItemRole.SpanningRole, self.line_1)

        self.la_author = QLabel(self.tab)
        self.la_author.setObjectName(u"la_author")

        self.formLayout.setWidget(3, QFormLayout.ItemRole.SpanningRole, self.la_author)

        self.la_family_name = QLabel(self.tab)
        self.la_family_name.setObjectName(u"la_family_name")

        self.formLayout.setWidget(4, QFormLayout.ItemRole.LabelRole, self.la_family_name)

        self.le_author_family_name = QLineEdit(self.tab)
        self.le_author_family_name.setObjectName(u"le_author_family_name")

        self.formLayout.setWidget(4, QFormLayout.ItemRole.FieldRole, self.le_author_family_name)

        self.la_given_name = QLabel(self.tab)
        self.la_given_name.setObjectName(u"la_given_name")

        self.formLayout.setWidget(5, QFormLayout.ItemRole.LabelRole, self.la_given_name)

        self.le_author_given_name = QLineEdit(self.tab)
        self.le_author_given_name.setObjectName(u"le_author_given_name")

        self.formLayout.setWidget(5, QFormLayout.ItemRole.FieldRole, self.le_author_given_name)
        ...
        self.formLayout.setWidget(7, QFormLayout.ItemRole.SpanningRole, self.la_company)

        self.la_company_name = QLabel(self.tab)
        self.la_company_name.setObjectName(u"la_company_name")

        self.formLayout.setWidget(8, QFormLayout.ItemRole.LabelRole, self.la_company_name)

        self.le_company_name = QLineEdit(self.tab)
        self.le_company_name.setObjectName(u"le_company_name")

        self.formLayout.setWidget(8, QFormLayout.ItemRole.FieldRole, self.le_company_name)

        self.la_company_description = QLabel(self.tab)
        self.la_company_description.setObjectName(u"la_company_description")

        self.formLayout.setWidget(9, QFormLayout.ItemRole.LabelRole, self.la_company_description)

        self.le_company_description = QLineEdit(self.tab)
        self.le_company_description.setObjectName(u"le_company_description")

        self.formLayout.setWidget(9, QFormLayout.ItemRole.FieldRole, self.le_company_description)
        ...
        self.formLayout.setWidget(10, QFormLayout.ItemRole.SpanningRole, self.line_3)

        self.la_fileschema = QLabel(self.tab)
        self.la_fileschema.setObjectName(u"la_fileschema")

        self.formLayout.setWidget(11, QFormLayout.ItemRole.LabelRole, self.la_fileschema)
        ...
        self.formLayout.setWidget(11, QFormLayout.ItemRole.FieldRole, self.cb_file_schema)

        self.la_default_pset_name = QLabel(self.tab)
        self.la_default_pset_name.setObjectName(u"la_default_pset_name")

        self.formLayout.setWidget(12, QFormLayout.ItemRole.LabelRole, self.la_default_pset_name)

        self.le_default_pset_name = QLineEdit(self.tab)
        self.le_default_pset_name.setObjectName(u"le_default_pset_name")

        self.formLayout.setWidget(12, QFormLayout.ItemRole.FieldRole, self.le_default_pset_name)

        self.label_3 = QLabel(self.tab)
        self.label_3.setObjectName(u"label_3")

        self.formLayout.setWidget(13, QFormLayout.ItemRole.LabelRole, self.label_3)
        ...
        self.formLayout_4.setWidget(3, QFormLayout.ItemRole.LabelRole, self.le_map_conv_orth_height)

        self.le_orthogonal_height = QLineEdit(self.wi_map_conversion)
        self.le_orthogonal_height.setObjectName(u"le_orthogonal_height")

        self.formLayout_4.setWidget(3, QFormLayout.ItemRole.FieldRole, self.le_orthogonal_height)
        ...
        self.formLayout_4.setWidget(7, QFormLayout.ItemRole.SpanningRole, self.line)


        self.formLayout_3.setWidget(1, QFormLayout.ItemRole.SpanningRole, self.wi_map_conversion)
